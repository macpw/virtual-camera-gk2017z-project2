...
public class Controller {
    ...
    private static ViewportModel viewportModel;
    ...
    public static void controller(final ViewportModel viewportModel, final View view) throws NullPointerException {
        ...
        Controller.addMotionActions();
        Controller.addRotationActions();
    }
    
    private static void addListenerToFocalDistanceJPanel() {
    ...
    private static void addMotionActions() {
    ...
    private static void addRotationActions() {
